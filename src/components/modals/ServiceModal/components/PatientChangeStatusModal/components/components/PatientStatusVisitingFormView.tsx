...
import { MAX_KIN_COUNT, OTHERS } from '@components/pages/TodayPatients';
...
export const PatientStatusVisitingFormView = ({
  control,
  isHistory,
  ...
  gender,
}: PatientStatusVisitingFormViewProps) => {
  ...
  return (
    <Grid container rowSpacing={2} columnSpacing={2} mb={2} data-testid="patientStatusVisitingFormView">
      {!isHistory && (
